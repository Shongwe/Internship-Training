from solution import fizzbuzz, fizzbuzz_mapped
...
def test_fizzbuzz_mapped_combination():
    # 105 is divisible by 3, 5, and 7 - "FizzBuzzZazz"
    assert fizzbuzz_mapped(105)[-1] == "FizzBuzzZazz"